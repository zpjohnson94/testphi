...
export const Route = createFileRoute("/plans")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Pick Free or Pro and start improving your SAT score today.",
      },
    ],
  }),
  component: Plans,
        ...
        <div className="text-center">
          ...
          <div
            ...
            style={{
              ...
              border: "1px solid rgba(246,240,250,0.12)",
            }}
          >
            ...
            <ToggleBtn active={billing === "annual"} onClick={() => setBilling("annual")}>
              Annual
              <span
                className="ml-2 inline-block px-2 py-0.5 rounded-full text-[10px] font-bold uppercase"
                style={{ background: "var(--spark)", color: "var(--ink)" }}
              >
                Save 60%
              </span>
            </ToggleBtn>
        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-2 max-w-3xl mx-auto">
            ...
            <div className="mt-2">
              {billing === "monthly" ? (
                <div className="score-num text-3xl text-[var(--lavender)]">
                  $30 <span className="text-base font-semibold opacity-70">/ mo</span>
                </div>
              ) : (
                <>
                  <div className="score-num text-3xl text-[var(--lavender)]">
          ...
          <div
            ...
            style={{
              ...
              border: "1.5px solid rgba(246,240,250,0.15)",
            }}
          >
            <h3 className="display text-2xl text-[var(--lavender)]">Free</h3>
            <div className="mt-2 score-num text-3xl text-[var(--lavender)]">
              $0 <span className="text-base font-semibold opacity-60">/ forever</span>
            </div>
            <ul className="mt-5 space-y-2.5">
...
function Feat({ children, pro }: { children: React.ReactNode; pro?: boolean }) {
  return (
    <li
      ...
      style={{ color: pro ? "var(--lavender)" : "rgba(246,240,250,0.85)" }}
    >
      <Check
        className="size-4 mt-0.5 shrink-0"
        style={{ color: pro ? "var(--volt)" : "var(--volt)" }}
      />
      <span>{children}</span>
    </li>
  );
