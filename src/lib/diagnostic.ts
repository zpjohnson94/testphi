...
export const QUESTIONS: DiagQuestion[] = [
  ...
  },
  {
    n: 2,
    section: "rw",
    domainLabel: "R&W · Information & Ideas",
    skill: "Main Idea",
    expectedSeconds: 75,
    correctWeight: 28,
    incorrectWeight: 20,
    passage:
      "Climate scientists rely on a mix of satellite imagery, ocean buoys, and ice-core samples to track how Earth's climate has shifted over decades and centuries. By weaving these data sources together, researchers build models that reveal long-term patterns rather than short-term noise.",
  ...
  },
  {
    n: 4,
    section: "rw",
    domainLabel: "R&W · Craft & Structure",
    skill: "Words in Context",
    expectedSeconds: 45,
    correctWeight: 22,
    incorrectWeight: 15,
    passage:
      "Her notes were meticulous — every margin filled with cross-references, every figure double-checked against the source.",
    prompt: 'As used in the text, what does the word "meticulous" most nearly mean?',
    choices: ["Careless", "Thorough", "Hasty", "Ambitious"],
    correctIndex: 1,
  },
  {
    n: 5,
    section: "math",
    domainLabel: "Math · Advanced Math",
    skill: "Quadratic Equations",
    expectedSeconds: 90,
    correctWeight: 30,
    incorrectWeight: 22,
    prompt: "Which of the following is a solution to x² − 5x + 6 = 0?",
    choices: ["x = 1", "x = 2", "x = 4", "x = 5"],
    correctIndex: 1,
  },
  {
    n: 6,
    ...
    incorrectWeight: 18,
    passage:
      "A profile of a long-distance runner emphasizes how she returned to training after each injury and continued chasing qualifying times that most peers had given up on.",
  ...
  },
  {
    n: 7,
    section: "math",
    domainLabel: "Math · Problem-Solving & Data",
  ...
  },
  {
    n: 8,
    section: "rw",
    domainLabel: "R&W · Expression of Ideas",
    skill: "Transitions",
    expectedSeconds: 45,
    correctWeight: 22,
    incorrectWeight: 15,
    prompt:
      "The experiment failed on the first attempt. ______, the team revised their approach and succeeded.",
    choices: ["Therefore", "However", "Meanwhile", "Similarly"],
    correctIndex: 1,
  },
  {
    n: 9,
  ...
  },
  {
    n: 10,
    section: "rw",
    domainLabel: "R&W · Standard English Conventions",
    skill: "Punctuation",
    expectedSeconds: 45,
    correctWeight: 20,
    incorrectWeight: 14,
    prompt:
      "The scientist published her findings ______ the results surprised the entire research community.",
    choices: ["and", "; however,", "because", "although"],
    correctIndex: 1,
  },
  {
    n: 11,
    ...
    incorrectWeight: 20,
    prompt:
      "A population doubles every 3 years. If it starts at 500, what is the population after 9 years?",
    choices: ["2000", "3000", "4000", "4500"],
    correctIndex: 2,
  },
  {
    n: 12,
    ...
    incorrectWeight: 16,
    passage:
      "In an essay about climate, the author writes that average global temperatures have climbed by more than 1.1°C since 1880, framing the figure as the centerpiece of her argument that warming is accelerating.",
  ...
  },
  {
    n: 13,
    section: "math",
    domainLabel: "Math · Geometry & Trig",
    skill: "Geometry: Area & Angles",
    expectedSeconds: 75,
    correctWeight: 22,
    incorrectWeight: 15,
  ...
  },
  {
    ...
    section: "math",
    domainLabel: "Math · Advanced Math",
    skill: "Nonlinear Functions & Graphs",
    expectedSeconds: 90,
    correctWeight: 30,
    incorrectWeight: 22,
    prompt:
      "The function f(x) = x² − 4x + 3 equals zero at two points. What are those values of x?",
    choices: ["x = 1 and x = 3", "x = −1 and x = −3", "x = 2 and x = 4", "x = 0 and x = 4"],
    correctIndex: 0,
  },
];
...
export function scoreFor(state: DiagState): Subscores {
  ...
  for (const a of state.answers) {
    ...
    if (a.correct) {
      correct += 1;
      if (q.section === "math") mathCorrect += 1;
      else rwCorrect += 1;
